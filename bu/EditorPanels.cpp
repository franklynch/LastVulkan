...
namespace EditorPanels
{
        ...
        EditorUiState& uiState)
    {
        ...
        ImGui::Checkbox("Wireframe requested", &uiState.wireframeRequested);
        ImGui::TextWrapped("Wireframe toggle is UI-only for now. Pipeline support can be added later.");
    }
